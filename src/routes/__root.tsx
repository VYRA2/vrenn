    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          O endereço não existe, foi removido ou está indisponível.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0F0F17" },
      { title: "VRENN — Não diga que vai fazer. Mostre." },
      { name: "description", content: "Não diga que vai fazer. Mostre." },
      { property: "og:title", content: "VRENN — Não diga que vai fazer. Mostre." },
      { property: "og:description", content: "Não diga que vai fazer. Mostre." },
      ...
      { name: "apple-mobile-web-app-title", content: "VRENN" },
      { name: "application-name", content: "VRENN" },
