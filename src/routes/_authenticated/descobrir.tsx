      ...
      <div className="mx-auto max-w-md px-5">
        ...
        {buscando ? (
          ...
          <>
            ...
            <div className="mt-6 mb-3 flex items-center justify-between"><h3 className="text-base font-bold">Comunidades em alta</h3><Link to="/equipes" className="inline-flex items-center gap-1 text-xs font-semibold text-primary-light">Ver todas <ArrowRight size={12} /></Link></div>
